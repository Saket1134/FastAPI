...
class Patient(BaseModel):
    ...
    age:Annotated[int,Field(...,description='Patient age')]
    gender:Annotated[Literal['male','female','others'],Field(...,description='Gender of patient')]
    height:Annotated[float,Field(...,description='Height of patient')]
...
@app.get('/sort')
def sort(sort_by: str=Query(...,description='sort on basis of height,weight,bmi'),order: str=Query(...,description='sort in asc or desc')):
...
def update_patient(patient_id:str,patient_update:PatientUpdate):
    ...
    update_patient_info=patient_update.model_dump(exclude_unset=True) #only entered value will come
